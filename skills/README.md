...
| `epub-special-layout` | 英文、文学结构、竖排/Ruby 与多看旧版弹注 fallback | `epub.typography.english.optimize`、`epub.notes.legacy-fallback`，写入；待实现：`epub.literary.structure.format`、`epub.vertical.ruby.optimize` |
