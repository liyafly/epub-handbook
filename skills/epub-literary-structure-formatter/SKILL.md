...
- 文白对照使用条目级 `section`，原文和白话先按源序上下相邻，再用左侧原文 `float` + 右侧普通块增强为左右对照；不用 table、flex、grid 或固定版式，规则见 `docs/guides/classical-modern-layout.md`。
...
4. 使用最小类集合：
   ...
   - `classical-modern`、`parallel-entry`、`parallel-pair`、`parallel-float-pair`、`parallel-col-classical`、`parallel-col-modern`、`parallel-clear`、`classical-text`、`modern-text`
