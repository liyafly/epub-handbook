...
工具的详细使用见 [diff-tool.md](diff-tool.md)。
...
参 [cleanup-flow.md](cleanup-flow.md)：
...
- [cleanup-flow.md](cleanup-flow.md) — 本工具调用所在的清洗流水线
- [cleanup-patterns.md](cleanup-patterns.md) — 典型脏 epub 模式，本指南是其中「资源层」处理的展开
...
见 [cleanup-flow.md](cleanup-flow.md)。
...
> 流程：见 [docs/pipeline/cleanup-flow.md](../../../docs/pipeline/cleanup-flow.md)
