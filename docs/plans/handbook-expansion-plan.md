...
> **2026-05-27 决策更新**：公版书 demo（鲁迅《呐喊》/《唐诗三百首》）不再作为 v1 交付项；Stage 4 唯一交付路径是 `samples/demo-books/` 自造样本。下文 §5.2 的公版书行、§5.3 S4-T1/S4-T2、§7.1 Q8、§8.4 PG 链接和 §9.5 公版书 commit 条目仅作历史记录，不再按本计划落地。
