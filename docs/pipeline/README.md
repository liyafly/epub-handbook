...
9. [skills-matrix.md](skills-matrix.md)：19 个 skill 在清洗 / 新书流程中的角色
10. [decisions.md](decisions.md)：Stage 落地决策与偏差记录
11. [reference-font-role-patterns.md](reference-font-role-patterns.md)：本地文学 EPUB 的脱敏字体角色分析
